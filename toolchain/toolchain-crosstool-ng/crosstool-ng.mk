...
$(STAMP_DIR)/ct-ng-toolchain-installed: $(STAMP_DIR)/ct-ng-toolchain-built
	...
	$(Q)CTNG_TUPLE="$$( $(call ctng,show-tuple) )";                     \
	    ...
	    echo "Copy external toolchain libraries to target...";          \
			...
			cp -r $(STAGING_DIR)/usr/lib/gconv 			$(TARGET_DIR)/usr/lib/;		\
			cp -r $(STAGING_DIR)/usr/share/locale 	$(TARGET_DIR)/usr/share/;	\
			cp -r $(STAGING_DIR)/usr/share/zoneinfo $(TARGET_DIR)/usr/share/;	\
...
ifeq ($(BR2_TOOLCHAIN_CTNG_experimental),y)
CTNG_FIX_DOT_CONFIG_SED += s:^\# (CT_EXPERIMENTAL) is not set:\1=y:;
endif
