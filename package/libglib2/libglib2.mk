...
LIBGLIB2_CONF_ENV += am_cv_pathless_PYTHON=python \
...
LIBGLIB2_DEPENDENCIES = host-python host-pkg-config host-libglib2 libffi zlib $(if $(BR2_NEEDS_GETTEXT),gettext libintl)

HOST_LIBGLIB2_DEPENDENCIES = host-python host-pkg-config host-libffi host-zlib
